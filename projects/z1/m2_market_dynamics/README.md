...
python -m projects.z1.core_solvency.run --scenario baseline

# Other named scenarios
python -m projects.z1.core_solvency.run --scenario collapse_case
python -m projects.z1.core_solvency.run --scenario stable_case
```
