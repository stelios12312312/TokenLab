...
| **THETA_MIN** | ratio | 0.10 | [0.05, 0.30] | **Critical** | **Treasury Health Solvency Floor:** Solvency boundary for the entire system. Below this, `SYS_throttle` is activated to preserve solvency. |
| **SR_BASE** | ratio | 0.10 | [0.01, 0.50] | **Highest** | **ACR-to-Z1U Conversion Rate:** Base conversion factor for settlements. Primary control over Z1U drain rate. The most sensitive parameter in the system. |
| **settlement_cap_epoch** | Z1U | 10,000,000 | [1M, 50M] | High | **Solvency Settlement Cap:** Maximum aggregate Z1U settled per epoch across all users. Essential anti-stampede mechanism. |
...
| **fee_rate_g5b** | ratio | 0.20 | [0.05, 0.40] | High | **Utility Treasury Capture Rate:** Capture rate on utility transactions. Primary revenue channel; must be balanced against systemic solvency. |
...
| **fee_rate_g9b** | ratio | 0.15 | [0.05, 0.30] | Medium | **Campaign Treasury Capture Rate:** Secondary revenue channel capturing a fraction of campaign settlements. |
