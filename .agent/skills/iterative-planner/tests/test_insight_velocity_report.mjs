...
assert(/Ritual transition rate:\s*5\.3%/.test(text), "text report shows ritual rate");
...
assert(json.ritual_replay.current_ritual_transition_rate_pct === 5.3, "json ritual rate 5.3%");
