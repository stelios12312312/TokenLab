"""Browser smoke for the public-staking-rewards-v3 demo (plan_2026-08-17_294429c6635af13c sc_7).
...
OUT = Path("scratch/browser_evidence/staking_smoke")
...
def main() -> int:
    with sync_playwright() as pw:
        ...
        page.select_option("#demo-select", value="public-staking-rewards-v3")
        ...
        check("STLB symbol visible", "STLB" in body)
