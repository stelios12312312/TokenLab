"""Browser smoke for the public-demand-history-v2 demo (plan_2026-08-17_294429c6635af13c sc_7).
...
OUT = Path("scratch/browser_evidence/demand_smoke")
...
def main() -> int:
    with sync_playwright() as pw:
        ...
        page.select_option("#demo-select", value="public-demand-history-v2")
        ...
        check("DTLB symbol visible", "DTLB" in body)
