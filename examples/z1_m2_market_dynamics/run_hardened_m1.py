...
import json
import os
from examples.z1_m2_market_dynamics.run import run_simulation
from examples.z1_m2_market_dynamics.scenarios import get_scenario_config
from examples.z1_m2_market_dynamics.metrics import summarize_run
...
def run_hardened_m1():
    ...
    # Save for reference
    df.to_csv('examples/z1_m2_market_dynamics/hardened_m1_trace.csv', index=False)
    with open('examples/z1_m2_market_dynamics/hardened_m1_summary.json', 'w') as f:
