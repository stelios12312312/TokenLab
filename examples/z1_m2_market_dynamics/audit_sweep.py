import pandas as pd
import numpy as np
from examples.z1_m2_market_dynamics.config import SolvencyConfig, COHORT_NAMES
...
def sweep_stability():
    ...
    df.to_csv('examples/z1_m2_market_dynamics/stability_frontier_5pct_fee.csv', index=False)
